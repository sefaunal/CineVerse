...
public class ImageUtils {
    ...
    public static String generateUniqueFilename(String uniqueName, String contentType) {
        ...
        return uniqueName + "_" + timestamp + "." + fileExtension;
    }
    ...
    public static String uploadImageToFirebase(MultipartFile image, String uniqueFilename) {
        try {
